...
// import "../assets/Business_SVG.svg";
// // import "leaflet/dist/leaflet.css";
// // import { MapContainer, TileLayer, Marker, Popup } from "react-leaflet";

// const AdminHome = () => {
//   // const position = [51.505, -0.09]; // Latitude, Longitude for the map's initial center
//   return (
//     <>
...
//               <span className="dark:text-red-50">Deals</span>
//             </h1>
...
//         </div>
//       </section>
//       <section className="p-1 dark:bg-gray-100 dark:text-gray-800">
...
//               75,000+
//             </p>
//             <p className="text-sm sm:text-base">Deals</p>
//           </div>
//           <div className="flex flex-col justify-start m-2 lg:m-6">
//             <p className="text-4xl font-bold leading-none lg:text-3xl">
//               6,000+
//             </p>
//             <p className="text-sm sm:text-base">Retailers</p>
//           </div>
//           <div className="flex flex-col justify-start m-2 lg:m-6">
//             <p className="text-4xl font-bold leading-none lg:text-3xl">
//               2 Million
...
//               1.3 Million
//             </p>
//             <p className="text-sm sm:text-base">App Downloads</p>
//           </div>
//         </div>
//       </section>
//       <section className="py-6 dark:bg-gray-100 dark:text-gray-900">
//         <div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:flex-row lg:justify-around">
...
//       </section>
//       {/* <section className="py-6 dark:bg-gray-100 dark:text-gray-900">
//         <div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 lg:space-y-12">
//           <h2 className="text-3xl font-bold text-center">Our Coverage Area</h2>
//           <MapContainer
//             center={[51.505, -0.09]}
//             zoom={13}
